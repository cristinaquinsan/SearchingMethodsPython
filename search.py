...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("Nodos visitados --> %s" % (visitado+1))
...
def myQueue_graph_search(problem):

    return graph_search(problem, myQueue())
def heuristicQueue_graph_search(problem):
    return graph_search(problem, heuristicsQueue(problem))
